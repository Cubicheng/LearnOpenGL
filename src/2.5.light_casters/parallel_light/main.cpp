...
int main() {
	...
	Shader shader("src/2.5.light_casters/parallel_light/vertex.shader", "src/2.5.light_casters/parallel_light/fragment.shader");
	Shader lightShader("src/2.5.light_casters/parallel_light/light_vertex.shader", "src/2.5.light_casters/parallel_light/light_fragment.shader");
