...
int main() {
	...
	Shader shader("src/2.5.light_casters/spotlight/vertex.shader", "src/2.5.light_casters/spotlight/fragment.shader");
	Shader lightShader("src/2.5.light_casters/spotlight/light_vertex.shader", "src/2.5.light_casters/spotlight/light_fragment.shader");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader.setUniformVec3("light.ambient", 0.2f * lightColor);
		shader.setUniformVec3("light.position", camera.get_camera_pos());
		shader.setUniformVec3("light.direction", camera.get_front_dir());
		shader.setUniformFloat("light.cutOff", cos(glm::radians(12.5f)));
		shader.setUniformFloat("light.outerCutOff", cos(glm::radians(17.5f)));
