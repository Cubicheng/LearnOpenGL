...
int main() {
	...
	Shader shader("src/2.5.light_casters/point_lamp/vertex.shader", "src/2.5.light_casters/point_lamp/fragment.shader");
	Shader lightShader("src/2.5.light_casters/point_lamp/light_vertex.shader", "src/2.5.light_casters/point_lamp/light_fragment.shader");
