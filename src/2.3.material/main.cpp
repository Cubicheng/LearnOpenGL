...
int main() {
	...
	Shader shader("src/2.3.material/vertex.shader", "src/2.3.material/fragment.shader");
	Shader lightShader("src/2.3.material/light_vertex.shader", "src/2.3.material/light_fragment.shader");
