...
int main() {
	...
	Shader shader("src/2.6.multiple_lights/vertex.shader", "src/2.6.multiple_lights/fragment.shader");
	Shader lightShader("src/2.6.multiple_lights/light_vertex.shader", "src/2.6.multiple_lights/light_fragment.shader");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		shader.setUniformVec3("dirlight.specular", lightColor);
		shader.setUniformVec3("dirlight.diffuse", 0.5f * lightColor);
		shader.setUniformVec3("dirlight.ambient", 0.2f * lightColor);
		shader.setUniformVec3("dirlight.direction", lightDirection);
		shader.setUniformVec3("spotlight.position", camera.get_camera_pos());
		shader.setUniformVec3("spotlight.direction", camera.get_front_dir());
