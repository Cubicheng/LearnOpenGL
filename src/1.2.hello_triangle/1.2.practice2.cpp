...
int main() {
	...
	*/
	...
	unsigned int vertexBufferObject[2];
	...
	glDeleteBuffers(1, &vertexBufferObject[0]);
	glDeleteVertexArrays(1, &vertexArrayObject[0]);
	glDeleteBuffers(1, &vertexBufferObject[1]);
	glDeleteVertexArrays(1, &vertexArrayObject[1]);
