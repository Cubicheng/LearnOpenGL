...
int main() {
	...
	Shader shader("src/2.1.colors/vertex.shader", "src/2.1.colors/fragment.shader");
	Shader lightShader("src/2.1.colors/vertex.shader", "src/2.1.colors/light_fragment.shader");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//object
		shader.use();
		shader.setUniform3f("lightColor", lightColor.x, lightColor.y, lightColor.z);shader.setUniform3f("lightColor", lightColor.x, lightColor.y, lightColor.z);
